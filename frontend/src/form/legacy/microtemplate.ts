/* Ported near-verbatim from frappe/public/js/frappe/microtemplate.js (was in the
 * removed form_vue_shell bundle). Defines frappe.render_template / render /
 * render_grid / render_tree / render_pdf. Wrapped so it runs after global
 * `frappe` is ready (installed by form/index.ts). Globals resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installMicrotemplate() {
