/* Ported verbatim from frappe/public/js/frappe/model/model.js. Wrapped in an
 ...
 *
 * frappe.model core (get_doc/get_value/set_value/add_child/get_list/df helpers + frappe.get_doc/get_children/get_list legacy aliases)
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installModelCore() {
...
Object.assign(frappe.model, {
	...
	init_doctype: function (meta) {
		...
		if (meta.__templates) {
			Object.assign(frappe.templates, meta.__templates);
		}
	},
