/* Ported verbatim from frappe/public/js/frappe/model/perm.js. Wrapped in an
 ...
 *
 * frappe.perm (get_perm / has_perm + READ/WRITE/... window constants)
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installPerm() {
