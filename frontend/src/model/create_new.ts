/* Ported verbatim from frappe/public/js/frappe/model/create_new.js. Wrapped in an
 ...
 *
 * frappe.model.get_new_doc / make_new_doc_and_get_name / copy_doc / open_mapped_doc
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installCreateNew() {
