/* Ported verbatim from frappe/public/js/frappe/model/sync.js. Wrapped in an
 ...
 *
 * frappe.model.sync / add_to_locals / docinfo (populates window.locals from boot + responses)
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installModelSync() {
