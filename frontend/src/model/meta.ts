/* Ported verbatim from frappe/public/js/frappe/model/meta.js. Wrapped in an
 ...
 *
 * frappe.meta (docfield maps, get_docfield, precision, sort/search fields)
 *
