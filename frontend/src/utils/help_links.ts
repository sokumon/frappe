/* Ported verbatim from frappe/public/js/frappe/utils/help_links.js. Wrapped in an
 ...
 *
 * frappe.help.help_links (doctype -> docs links)
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, repl, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installHelpLinks() {
