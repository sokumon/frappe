/* Ported verbatim from frappe/public/js/frappe/utils/address_and_contact.js. Wrapped in an
 ...
 *
 * frappe.contacts (render_address_and_contact / clear / get_last_doc)
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, repl, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installAddressAndContact() {
