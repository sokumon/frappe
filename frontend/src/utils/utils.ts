/* Ported verbatim from frappe/public/js/frappe/utils/utils.js. Wrapped in an
 ...
 *
 * frappe.utils.* grab-bag (comma_or, filter_dict, escape_html, get_url, sleep, deep_equal wrappers, xss/scrub helpers, ...)
 *
...
export function installUtilsCore() {
