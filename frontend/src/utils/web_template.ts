/* Ported verbatim from frappe/public/js/frappe/utils/web_template.js. Wrapped in an
 ...
 *
 * frappe.utils.open_web_template_values_editor (Web Template value editor dialog)
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, repl, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installWebTemplate() {
frappe.provide("frappe.utils");
// In the legacy web_template.bundle this fn was reachable via the bundle scope;
// expose it on frappe.utils so the port is callable.
frappe.utils.open_web_template_values_editor = open_web_template_values_editor;
