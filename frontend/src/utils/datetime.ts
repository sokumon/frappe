/* Ported verbatim from frappe/public/js/frappe/utils/datetime.js. Wrapped in an
 ...
 *
 * frappe.datetime (now/str_to_user/obj_to_str/get_diff/timezone helpers, moment wrappers)
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, repl, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installDatetime() {
