/* Ported verbatim from frappe/public/js/frappe/utils/pretty_date.js. Wrapped in an
 ...
 *
 * frappe.datetime.prettyDate / comment_when + window.comment_when + refresh_when interval
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, repl, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installPrettyDate() {
