/* Ported verbatim from frappe/public/js/frappe/utils/common.js. Wrapped in an
 ...
 *
 * frappe.avatar / avatar_group / get_palette / get_abbr / gravatars (md5)
 *
