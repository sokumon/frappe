/* Ported verbatim from frappe/public/js/frappe/utils/dashboard_utils.js. Wrapped in an
 ...
 *
 * frappe.dashboard_utils (render_chart_filters / get_dashboard_settings ...)
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, repl, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installDashboardUtils() {
