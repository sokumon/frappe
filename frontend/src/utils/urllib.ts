/* Ported verbatim from frappe/public/js/frappe/utils/urllib.js. Wrapped in an
 ...
 *
 * frappe.urllib (get_arg / get_dict / get_full_url / get_base_url ...)
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, repl, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installUrllib() {
frappe.urllib = {
