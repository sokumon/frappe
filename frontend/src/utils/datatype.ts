/* Ported verbatim from frappe/public/js/frappe/utils/datatype.js. Wrapped in an
 ...
 *
 * window.cstr/cint/toTitle/is_null/validate_email/validate_phone/nth/has_words/has_common ...
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, repl, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installDatatype() {
