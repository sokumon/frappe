/* Ported verbatim from frappe/public/js/frappe/utils/number_format.js. Wrapped in an
 ...
 *
 * window.flt/format_currency/fmt_money/precision/in_list/get_number_format ... (needs datatype)
 *
 * Globals ($, __, frappe, locals, cint, cstr, flt, repl, ...) resolve off window. */
/* eslint-disable */
// @ts-nocheck
export function installNumberFormat() {
