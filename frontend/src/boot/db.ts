/* Ported verbatim from frappe/public/js/frappe/db.js (a desk.bundle file from
 ...
 * none — pure frappe.call wrappers).
 *
 * frappe.db.* thin frappe.call/xcall wrappers (get_list/get_value/get_doc/set_value/insert/delete_doc/count/exists/get_link_options ...). get_doc keeps .fail() — request.ts shims it.
 *
